...
locals {
  container_definition = {
    ...
    healthCheck            = length(var.healthcheck.command) > 0 ? var.healthcheck : null
    firelensConfiguration  = var.firelens_configuration.type == null ? null : var.firelens_configuration
    logConfiguration = {
